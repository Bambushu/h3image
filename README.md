...
**Stress test:** a 16 MP group painting built from a blank canvas by H3 alone in 35 masked passes (15 on a pod, 20 local), every pass leaving the rest of the canvas at SSIM 1.000: [`benchmark/nachtwacht/`](benchmark/nachtwacht/README.md).
